...
public class ES2UserType_AddonVelocitySensor1D : ES2Type
{
	public override void Write(object obj, ES2Writer writer)
	{
		AddonVelocitySensor1D data = (AddonVelocitySensor1D)obj;
	...
	{
		AddonVelocitySensor1D data = new AddonVelocitySensor1D();
		Read(reader, data);
		return data;
	}
	...
	{
		AddonVelocitySensor1D data = (AddonVelocitySensor1D)c;
	...
	public ES2UserType_AddonVelocitySensor1D():base(typeof(AddonVelocitySensor1D)){}
}
