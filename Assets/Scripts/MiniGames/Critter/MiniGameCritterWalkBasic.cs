...
public class MiniGameCritterWalkBasic : MiniGameBase
{
    ...
    /*
    public MiniGameCritterWalkBasic(CreatureBodyGenome templateBodyGenome)
    {
    ...
    private void CheckGroundCollision(GameObject segmentObject, int segmentIndex)
    {
        ...
        if (penetrationDepth < 0f)
        {
            ...
            float friction = segmentObject.GetComponent<GamePieceCreatureV1Segment>().frictionForceMultiplier * -penetrationDepth * 500f;
