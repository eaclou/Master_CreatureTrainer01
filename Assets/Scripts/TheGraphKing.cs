...
public class TheGraphKing {
	...
	public void BuildTexturesFitnessPerGen(Player player) {
	...
	public void BuildTexturesHistoryPerGen(Player player) {
		DataManager dataManager = player.dataManager;
	...
	public void BuildTexturesFitnessBasic(DataManager dataManager) {
		int texWidth = dataManager.generationDataList.Count;
	...
	public void BuildTexturesFitnessAgentsLastGen(DataManager dataManager) {
		int genNumber;
